...
class WordLSTMEncoder(nn.Module):
    def __init__(self, vocab):
        ...
        print("extword_size.shape", extword_embed.shape)
...
def get_examples(data, vocab, max_sent_len=256, max_segment=8):
    ...
    for text, label in zip(data['text'], data['label']):
        ...
        for sent_len, sent_words in sents_words:
            ...
            # 注意，这里的extword_ids使用的是预训练的word embedding，所以它的word ids 与本网络的输入 不太一样
...
save_model = 'data/rnn.bin'
save_test = 'data/result_bert.csv'
